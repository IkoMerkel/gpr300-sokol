...
struct {
    ...
    float slot1 = 16.0f;
    float slot2 = 0.25f;
    glm::vec3 waterColor{0.0f,0.4f,1.0f};
} debug;

Scene::Scene()
{
    suzanne = std::make_unique<ew::Model>("assets/models/suzanne.obj");
    water = std::make_unique<ew::Shader>("assets/shaders/default.vs", "assets/shaders/doubledash/water.fs");
    ...
    water_tex = std::make_unique<ew::Texture>("assets/textures/doubledash/wave_tex.png");
    water_spec = std::make_unique<ew::Texture>("assets/textures/doubledash/wave_spec.png");
    water_warp = std::make_unique<ew::Texture>("assets/textures/doubledash/wave_warp.png");
...
void Scene::Render(void)
{
    ...
    glBindFramebuffer(GL_FRAMEBUFFER, fbo);
    {
        ...
        water->setVec3("camera_pos", camera.position);
...
void Scene::Debug(void)
{
    ...
    ImGui::ColorEdit3("Color", &debug.waterColor.x);
    switch (selectedMenu)
    {
    case 0:
